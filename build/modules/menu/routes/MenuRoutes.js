...
var MenuRoutes_exports = {};
__export(MenuRoutes_exports, {
  menuRoutes: () => menuRoutes
});
module.exports = __toCommonJS(MenuRoutes_exports);
...
async function menuRoutes(fastify) {
  fastify.post("/menu", MenuController_default.createMenu);
  fastify.get("/menu", MenuController_default.getAllMenus);
  fastify.get("/:id", MenuController_default.getMenuById);
  fastify.put("/:id", MenuController_default.updateMenu);
  fastify.delete("/:id", MenuController_default.deleteMenu);
}
