...
var EntrepreneurRoutes_exports = {};
__export(EntrepreneurRoutes_exports, {
  entrepreneurRoutes: () => entrepreneurRoutes
});
module.exports = __toCommonJS(EntrepreneurRoutes_exports);
...
async function entrepreneurRoutes(fastify) {
  fastify.post(
    "/entrepreneurs",
