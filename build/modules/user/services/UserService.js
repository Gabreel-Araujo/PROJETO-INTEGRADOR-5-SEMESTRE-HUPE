...
var UserController = class {
  ...
  async register(request, reply) {
    const createUserSchema = import_zod.z.object({
      ...
      email: import_zod.z.string().email(),
      password: import_zod.z.string(),
      role: import_zod.z.enum(["ADMIN", "ENTREPRENEUR", "CUSTOMER"]).default("CUSTOMER"),
      customerId: import_zod.z.string().nullable().optional()
    });
  ...
  async update(request, reply) {
    ...
    const updateUserSchema = import_zod.z.object({
      ...
      role: import_zod.z.enum(["ADMIN", "ENTREPRENEUR", "CUSTOMER"]).optional(),
      customerId: import_zod.z.string().nullable().optional()
    });
...
var EntrepreneurController = class {
  ...
  async create(request, reply) {
    const createEntrepreneurSchema = import_zod2.z.object({
  ...
  async update(request, reply) {
    const id = request.params.id;
    const updateEntrepreneurSchema = import_zod2.z.object({
